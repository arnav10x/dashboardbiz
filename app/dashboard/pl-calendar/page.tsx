...
export default function CalendarPage() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-7 py-7 animate-in mobile-compact-page">
        <div className="mb-5">
        ...
        {activeTab === 'schedule' ? (
          ...
          <>
            <div className="mb-5 grid grid-cols-5 gap-3 mobile-card-strip">{[
